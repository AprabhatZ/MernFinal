...
function Card() {
  ...
  return (
    ...
    // </div>
    <div className=" bg-slate-500 m-4 lg:m-8 rounded-lg py-20 px-8 mt-32 grid grid-cols-1  lg:grid-cols-3 xl:grid-cols-4 sm:grid-cols-2 grid-flow-row gap-y-16 sm:gap-y-2 md:gap-y-0">
